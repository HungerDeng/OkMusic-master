package com.gdut.dkmfromcg.commonlib.widget.tabsegment;
...
import com.gdut.dkmfromcg.commonlib.util.color.QMUIColorHelper;
import com.gdut.dkmfromcg.commonlib.util.display.QMUIDisplayHelper;
import com.gdut.dkmfromcg.commonlib.util.drawable.QMUIDrawableHelper;
...
//    private AdapterChangeListener mAdapterChangeListener;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDefaultSelectedColor = ContextCompat.getColor(context, R.color.qmui_config_color_blue);
    ...
    public static class Tab {
        ...
        public void setSignCountMargin(int marginRight, int marginTop) {
            ...
            if (mSignCountTextView != null && mSignCountTextView.getLayoutParams() != null) {
                ((ViewGroup.MarginLayoutParams) mSignCountTextView.getLayoutParams()).rightMargin = marginRight;
                ((ViewGroup.MarginLayoutParams) mSignCountTextView.getLayoutParams()).topMargin = marginTop;
            }
        }
        ...
        private TextView ensureSignCountView(Context context) {
            if (mSignCountTextView == null) {
                ...
                RelativeLayout.LayoutParams signCountLp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, QMUIAttrHelper.getAttrDimen(context, R.attr.qmui_tab_sign_count_view_minSize));
        ...
        public void showSignCountView(Context context, int count) {
            ...
            if (count != 0) {
                // 显示未读数
                signCountLp.height = QMUIAttrHelper.getAttrDimen(mSignCountTextView.getContext(), R.attr.qmui_tab_sign_count_view_minSize_with_text);
                mSignCountTextView.setLayoutParams(signCountLp);
                mSignCountTextView.setMinHeight(QMUIAttrHelper.getAttrDimen(mSignCountTextView.getContext(), R.attr.qmui_tab_sign_count_view_minSize_with_text));
                mSignCountTextView.setMinWidth(QMUIAttrHelper.getAttrDimen(mSignCountTextView.getContext(), R.attr.qmui_tab_sign_count_view_minSize_with_text));
                mSignCountTextView.setText(getNumberDigitsFormattingValue(count));
            } else {
                // 显示红点
                signCountLp.height = QMUIAttrHelper.getAttrDimen(mSignCountTextView.getContext(), R.attr.qmui_tab_sign_count_view_minSize);
                mSignCountTextView.setLayoutParams(signCountLp);
                mSignCountTextView.setMinHeight(QMUIAttrHelper.getAttrDimen(mSignCountTextView.getContext(), R.attr.qmui_tab_sign_count_view_minSize));
                mSignCountTextView.setMinWidth(QMUIAttrHelper.getAttrDimen(mSignCountTextView.getContext(), R.attr.qmui_tab_sign_count_view_minSize));
        ...
        private RelativeLayout.LayoutParams getDefaultCustomLayoutParam() {
            return new RelativeLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT);
        }
...
//    }
    ...
    private final class Container extends ViewGroup {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (mIndicatorView != null) {
                LayoutParams bottomLp = mIndicatorView.getLayoutParams();
