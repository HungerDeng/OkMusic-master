...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public MediaNotificationManager(MusicService service) throws RemoteException {
        ...
        mNotificationColor = Color.WHITE;
    ...
    private final MediaControllerCompat.Callback mCb = new MediaControllerCompat.Callback() {
        ...
        public void onPlaybackStateChanged(@NonNull PlaybackStateCompat state) {
            ...
            Logger.d(TAG, "Received new playback state" + state);
        ...
        public void onMetadataChanged(MediaMetadataCompat metadata) {
            mMetadata = metadata;
            Logger.d(TAG, "Received new metadata " + metadata);
            Notification notification = createNotification();
            if (notification != null) {
                mNotificationManager.notify(NOTIFICATION_ID, notification);
            }
        ...
        public void onSessionDestroyed() {
            ...
            try {
                ...
                Logger.e(TAG, Logger.getStackTraceString(e) + "could not connect media controller");
            }
        }
    };

    private Notification createNotification() {
        Logger.d(TAG, "updateNotificationMetadata. mMetadata=" + mMetadata);
    ...
    private void setNotificationPlaybackState(NotificationCompat.Builder builder) {
        Logger.d(TAG, "updateNotificationPlaybackState. mPlaybackState=" + mPlaybackState);
        ...
        AlbumArtCache.getInstance().fetch(bitmapUrl, new AlbumArtCache.FetchListener() {
            ...
            public void onFetched(String artUrl, Bitmap bitmap, Bitmap icon) {
                if (mMetadata != null && mMetadata.getDescription().getIconUri() != null &&
                    ...
                    Logger.d(TAG, "fetchBitmapFromURLAsync: set bitmap to " + artUrl);
