...
/**
 * Interface representing either Local or Remote Playback. The {@link com.gdut.dkmfromcg.playmusiclib.MusicService} works
 * directly with an instance of the Playback object to make the various calls such as
 * play, pause etc.
 *
 * 播放时的具体操作,比如 mediaPlayer.start(),mediaPlayer.stop()等
 */
